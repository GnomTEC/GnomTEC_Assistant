-- **********************************************************************
-- GnomTECWidgetContainerLayoutGrid
-- Version: 6.0.2.1
-- Author: Peter Jack
...
-- **********************************************************************
local MAJOR, MINOR = "GnomTECWidgetContainerLayoutGrid-1.0", 1
...
function GnomTECWidgetContainerLayoutGrid(init)
	...
	function self.LogMessage(logLevel, message, ...)
		protected.LogMessage(CLASS_WIDGET, logLevel, "GnomTECWidgetContainerLayoutGrid", message, ...)
	end
	...
	do
		...
		protected.LogMessage(CLASS_WIDGET, LOG_DEBUG, "GnomTECWidgetContainerLayoutGrid", "New instance created (%s)", protected.UID)
	end
